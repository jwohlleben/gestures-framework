...
public class XMLReader
{
    ...
    public boolean read()
    {
        ...
        frameLength = Integer.parseInt(document.getElementsByTagName("frameLength").item(0).getTextContent());
        outputNeurons = Integer.parseInt(document.getElementsByTagName("outputNeurons").item(0).getTextContent());
